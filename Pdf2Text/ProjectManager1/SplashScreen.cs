...
namespace ProjectManager1
{
    public partial class SplashScreen : Form
    {
        ...
        {
            ProjectManager1Form.InitializationStatusChanged += new InitializationStatusChangedEventHandler(this.Application_InitializationStatusChanged);
            ProjectManager1Form.InitializationComplete += new EventHandler(this.Application_InitializationComplete);
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            ProjectManager1Form.SplashLoadedEvent.Set();
        }
        #endregion //OnLoad
